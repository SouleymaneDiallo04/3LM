...
/**
 * Référentiel officiel des 101 départements français (COG INSEE 2024),
 * rattachés à leur région. Codes alphanumériques : 2A/2B (Corse),
 * 971-976 (outre-mer).
 */
class DepartmentSeeder extends Seeder
{
    /** @var array<int, array{string, string, string}> [code, nom, code région] */
    ...
    public function run(): void
    {
        ...
        DB::table('departments')->upsert($rows, ['code'], ['name', 'region_code']);
    }
}
